...
<div class="mb-3">
    ...
    <a  href="{{ route('admin.dataPendaftar') }}"><i class="fa-solid fa-arrow-left-long fa-2x text-dark"></i></a>
</div>
<div class="card-body border" style="background-color: rgb(255, 255, 255)">
    ...
    <div class="row justify-content-center mt-5">
        ...
        <div class="col-lg-8 border" style="color: rgba(0, 0, 0, 0.726)">
            ...
            <p class="ps-5 mt-2">Tempat & Tanggal Lahir <span style="margin-left: 6rem">:</span><span class="ms-4">{{ $user->tempatLahir}}, {{ $user->tanggalLahir}}</span></p>
