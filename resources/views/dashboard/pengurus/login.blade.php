            ...
            <div class="col-lg-5">
                <div class="card-body bg-light rounded">
                    <main class="form-signin ">
                        <form action="{{ route('user.check') }}" method="post" class="p-4" >
                            ...
                            <h5 class="text-center mb-3 fw-bold text-dark">PSB Bustanul Falah</h5>
                            ...
                            <button class="w-100 btn btn-lg button-signin text-light" type="submit">Login</button>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-10 mt-4 mb-4">
                                <div class="p-2 mt-4 mb-4">
                                    <form class="user" action="{{ route('pengurus.check') }}" method="post">
                                        <div class="text-center ">
                                            <img class="mb-3" src="https://i.postimg.cc/Qd2Pfmbr/logo.png" alt="" width="100">
                                        </div>
                                        <div class="text-center mb-3">
                                            <h5 class=" font-weight-bold text-dark">Panitia PSB Butanul Falah</h5>
                                        </div>
                                        @if (session()->has('success'))
                                            <div class="alert alert-success alert-dismissible fade show" role="alert">
                                                {{ session('success') }}
